    ...
    <div class="min-h-screen bg-gray-100 flex">
        ...
        <aside class="w-64 bg-white shadow-sm flex flex-col">
            ...
            <div class="p-3 border-t">
                ...
                <div class="mt-3 pt-3 border-t border-gray-100">
                    <RouterLink to="/settings" class="flex items-center gap-2 px-3 py-2 text-sm rounded-md text-gray-600 hover:bg-gray-100 transition-colors" active-class="bg-gray-100 text-gray-900 font-medium">
