        ...
        <template v-else-if="campaign.posts?.length">
            ...
            <div class="flex gap-6">
                ...
                <div class="flex-1 bg-white rounded-xl border border-gray-200 p-5" v-if="activePost">
                    ...
                    <template v-else>
                        <!-- Generated image -->
                        <div v-if="activePost.image_url" class="mb-4">
                            <div class="flex items-center justify-between mb-1">
                                <p class="text-xs font-medium text-gray-500">Post Image <span class="text-gray-400">(generated by NVIDIA FLUX)</span></p>
                                <a :href="activePost.image_url" download
                                    class="text-xs text-indigo-600 hover:underline">⬇ Download</a>
                            </div>
                            <img :src="activePost.image_url" alt="Generated post image"
                                @click="lightboxUrl = activePost.image_url"
                                class="w-full max-w-sm rounded-lg border border-gray-200 cursor-pointer hover:opacity-90 transition-opacity" />
                        </div>
                        ...
                        <div v-if="activePost.image_prompt" class="mb-4">
                            <p class="text-xs font-medium text-gray-500 mb-1">Image Prompt <span class="text-gray-400">(used for the image above — reusable in DALL-E / Midjourney)</span></p>
